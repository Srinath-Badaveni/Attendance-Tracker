...
app.post("/attendance", async (req, res) => {
    ...
    console.log(`[${new Date().toLocaleTimeString()}] Accessing portal for: ${rollNo}`);
    ...
    try {
        ...
        if (!attendanceData) {
            return res.status(404).json({ error: "Attendance data structure mismatch." });
        }
        console.log(`[${new Date().toLocaleTimeString()}] Successfully retrieved data for: ${rollNo}`);
